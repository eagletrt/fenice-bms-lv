...
#include "mcp23017_base.h"                       /* GPIO extender with led             */
#include "main.h"
...
void LedBlinkTask(void)
{
  ...
  if (TimerGet() >= nextBlinkEvent)
  {
    ...
    if (ledOn == BLT_FALSE)
    {
      ...
      mcp23017_set_gpio(&hmcp, MCP23017_PORTB, LED_3, GPIO_PIN_SET);
    }
    else
    {
      ledOn = BLT_FALSE;
      //HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, GPIO_PIN_RESET);
      mcp23017_set_gpio(&hmcp, MCP23017_PORTB, LED_3, GPIO_PIN_RESET);
    }
