...
#define MEAS_MUX_FB_INTERVAL_MS                 100
#define MEAS_MUX_HALL_INTERVAL_MS               120
#define MEAS_AS_RELAY_LVMS_BATT_OUT_INTERVAL_MS 200
...
enum {
    ...
    MEAS_MUX_FB_FLAG                 = 2,
    MEAS_MUX_HALL_FLAG               = 4,
    MEAS_AS_RELAY_LVMS_BATT_OUT_FLAG = 8,
};
/*enum {
    MEAS_OPEN_WIRE                              = 1,
